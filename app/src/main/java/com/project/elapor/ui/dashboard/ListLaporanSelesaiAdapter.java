...
public class ListLaporanSelesaiAdapter extends RecyclerView.Adapter<ListLaporanSelesaiAdapter.ViewHolder> {



    private final ArrayList<ListLaporanSelesaiModel> listPengaduan = new ArrayList<>();

    String role, page;
    public ListLaporanSelesaiAdapter(String role, String page) {
        this.role = role;
        this.page = page;
    }

    @SuppressLint("NotifyDataSetChanged")
    public void setData(ArrayList<ListLaporanSelesaiModel> items) {
        listPengaduan.clear();
    ...
    @NonNull
    @Override
    public ListLaporanSelesaiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pengaduan, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListLaporanSelesaiAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(ListLaporanSelesaiModel model, String role, String page, ArrayList<ListLaporanSelesaiModel> listPengaduan) {
