...
import com.project.elapor.ui.pengaduan_terkirim.message.MessageDatabaseTerkirim;
import com.project.elapor.ui.pengaduan_terkirim.message.MessageModelTerkirim;
...
public class MessageActivity extends AppCompatActivity {
    ...
    private final ArrayList<MessageModel> retrieveLastMessage = new ArrayList<>();
    ...
    private void sendMessage(String message, boolean isText) {
        ...
        if(role.equals("user")) {
            MessageDatabase.sendChat(message, format, model.getUid(), model.getUserUid(), isText,model.getUserName(), timeInMillis);
        } else {
            MessageDatabase.sendChat(message, format, model.getUid(), model.getAdminUid(), isText,model.getAdminName(), timeInMillis);
            getLastResponseTime();
        }
