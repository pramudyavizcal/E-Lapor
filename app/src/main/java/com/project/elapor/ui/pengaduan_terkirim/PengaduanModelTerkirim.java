...
public class PengaduanModelTerkirim implements Parcelable {
    ...
    public PengaduanModelTerkirim(){}

    protected PengaduanModelTerkirim(Parcel in) {
        uid = in.readString();
    ...
    public static final Creator<PengaduanModelTerkirim> CREATOR = new Creator<PengaduanModelTerkirim>() {
        @Override
        public PengaduanModelTerkirim createFromParcel(Parcel in) {
            return new PengaduanModelTerkirim(in);
        }

        @Override
        public PengaduanModelTerkirim[] newArray(int size) {
            return new PengaduanModelTerkirim[size];
        }
    };
